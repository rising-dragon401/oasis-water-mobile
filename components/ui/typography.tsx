...
const P = React.forwardRef<TextRef, SlottableTextProps>(
	({ className, asChild = false, ...props }, ref) => {
		...
		return (
			<Component
				className={cn("text-base text-primary web:select-text", className)}
				ref={ref}
				{...props}
			/>
		);
...
const Lead = React.forwardRef<TextRef, SlottableTextProps>(
	({ className, asChild = false, ...props }, ref) => {
		...
		return (
			<Component
				className={cn("text-xl text-primary web:select-text", className)}
				ref={ref}
				{...props}
			/>
		);
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(
	({ className, asChild = false, ...props }, ref) => {
		...
		return (
			<Component
				className={cn(
					"text-sm text-primary  leading-none web:select-text",
					className,
				)}
				ref={ref}
				{...props}
